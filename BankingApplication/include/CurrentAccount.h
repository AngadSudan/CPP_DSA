...
class CurrentAccount: public Account {
    protected:
        const string accountType = "CURRENT";
        const double interestRate = 5;
    public:
        CurrentAccount(int accountNumber, string name, double balance):Account(accountNumber,name,balance){}
        ...
        void getDetails() override{
            cout<<"[CURRENT BALANCE]: Amount in money is - "<< this->balance << endl; 
        }
